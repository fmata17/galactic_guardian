...
class Music:
    ...
    def __init__(self):
        ...
        self.laser_sound = pygame.mixer.Sound('resources/lasergun.ogg')
        self.alien_sound = pygame.mixer.Sound('resources/alien_blast.ogg')
        self.ship_sound = pygame.mixer.Sound('resources/ship_explosion.ogg')
